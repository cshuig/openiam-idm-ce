...
public interface UserDataService {
	...
	/**
	 * Returns a user object for the id. The dependents flag determines if the
	 * method return the dependent objects such as Attributes, EmailAddress,
	 * Phone and Address. True will return these collections. False will not.
	...
	public Map<String, org.openiam.idm.srvc.user.dto.UserAttribute> getUserAsMap(
			String userId);
	...
	@WebMethod
	@XmlJavaTypeAdapter(org.openiam.idm.srvc.user.dto.UserAttributeMapAdapter.class)
	public Map<String, org.openiam.idm.srvc.user.dto.UserAttribute> getAllAttributes(
			String userId);

	/*
	 * @WebMethod(exclude=true) public UserDAO getUserDao();
	 * 
	 * @WebMethod(exclude=true) public void setUserDao(UserDAO userDao);
	 * 
	 * @WebMethod(exclude=true) public UserAttributeDAO getUserAttributeDao();
	 * 
	 * @WebMethod(exclude=true) public void setUserAttributeDao(UserAttributeDAO
	 * userAttributeDao);
	 * 
	 * @WebMethod(exclude=true) public UserNoteDAO getUserNoteDao();
	 * 
	 * @WebMethod(exclude=true) public void setUserNoteDao(UserNoteDAO
	 * userNoteDao);
	 * 
	 * @WebMethod(exclude=true) public AddressDAO getAddressDao();
	 * 
	 * @WebMethod(exclude=true) public void setAddressDao(AddressDAO
	 * addressDao);
	 * 
	 * @WebMethod(exclude=true) public EmailAddressDAO getEmailAddressDao();
	 * 
	 * @WebMethod(exclude=true) public void setEmailAddressDao(EmailAddressDAO
	 * emailAddressDao);
	 * 
	 * @WebMethod(exclude=true) public PhoneDAO getPhoneDao();
	 * 
	 * @WebMethod(exclude=true) public void setPhoneDao(PhoneDAO phoneDao);
	 * 
	 * @WebMethod(exclude=true) public SupervisorDAO getSupervisorDao();
	 * 
	 * @WebMethod(exclude=true) public void setSupervisorDao(SupervisorDAO
	 * supervisorDao);
	 */
}