...
public class UserReport implements ReportDataSetBuilder {
    ...
    public ReportDataDto getReportData(ReportQueryDto query) {
        ...
        println "UserReport data source, request: " + query.queryParams.values().join(", ")
        ...
        println "UserReport data source, responce size: " + reportTable.row.size() + " rows"
