...
def UserEntity cardinalityUser = req.getNotificationParam("CARDINALITY_USER")?.valueObj
...
emailStr = "Dear " + toNotify.firstName + " " + toNotify.lastName + ": \n\n" +
 	"The following request has been rejected" + (cardinalityUser? " by ${cardinalityUser.firstName} ${cardinalityUser.lastName}" as String: "") + ":\n\n" +
