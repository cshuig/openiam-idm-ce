...
*/
public class ProvisionServiceProvisionPostProcessor extends AbstractProvisionPostProcessor<ProvisionUser> {
        ...
        for(Role role : user.getRoles()) {
            if (ORGANIZATION_ADMIN_ROLEID.equals(role.id)) {
                ...
                if (organization != null) {
                    ...
                    approverAssociation.setApproverEntityId(user.getId());
