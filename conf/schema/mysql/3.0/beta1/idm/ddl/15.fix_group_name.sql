...
ALTER TABLE GRP_ATTRIBUTES DROP FOREIGN KEY grp_attributes_ibfk_1;
ALTER TABLE GRP_ATTRIBUTES MODIFY COLUMN GRP_ID VARCHAR(32) NOT NULL;
ALTER TABLE GRP_ATTRIBUTES ADD CONSTRAINT grp_attributes_ibfk_1 FOREIGN KEY (GRP_ID) REFERENCES GRP(GRP_ID);
