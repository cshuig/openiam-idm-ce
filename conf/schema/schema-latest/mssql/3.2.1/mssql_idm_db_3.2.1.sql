...
AS
		...
		DECLARE cur1_ CURSOR FOR (SELECT RESOURCE_ID, NAME FROM AUTH_PROVIDER WHERE RESOURCE_ID IS NOT NULL);
		OPEN cur1_;
		
		FETCH NEXT FROM cur1_ INTO @theId, @theName;
		WHILE @@FETCH_STATUS = 0
		BEGIN
...
AS
		DECLARE @theId NVARCHAR(32);
		DECLARE @theName NVARCHAR(250);
		DECLARE cur2_ CURSOR FOR (SELECT ADMIN_RESOURCE_ID, COMPANY_NAME FROM COMPANY WHERE ADMIN_RESOURCE_ID IS NOT NULL);
		OPEN cur2_;
		
		FETCH NEXT FROM cur2_ INTO @theId, @theName;
		WHILE @@FETCH_STATUS = 0
		BEGIN
			IF (@theId IS NOT NULL AND @theName IS NOT NULL) 
			BEGIN
...
AS
		DECLARE @theId NVARCHAR(32);
		DECLARE @theName NVARCHAR(250);
		DECLARE cur3_ CURSOR FOR (SELECT RESOURCE_ID, CONTENT_PROVIDER_NAME FROM CONTENT_PROVIDER WHERE RESOURCE_ID IS NOT NULL);
		OPEN cur3_;
		
		FETCH NEXT FROM cur3_ INTO @theId, @theName;
		WHILE @@FETCH_STATUS = 0
		BEGIN
			IF (@theId IS NOT NULL AND @theName IS NOT NULL) 
			BEGIN
...
AS
		DECLARE @theId NVARCHAR(32);
		DECLARE @theName NVARCHAR(250);
		DECLARE cur4_ CURSOR FOR (SELECT ADMIN_RESOURCE_ID, GRP_NAME FROM GRP WHERE ADMIN_RESOURCE_ID IS NOT NULL);
		OPEN cur4_;
		
		FETCH NEXT FROM cur4_ INTO @theId, @theName;
		WHILE @@FETCH_STATUS = 0
		BEGIN
			IF (@theId IS NOT NULL AND @theName IS NOT NULL) 
			BEGIN
...
AS
		DECLARE @theId NVARCHAR(32);
		DECLARE @theName NVARCHAR(250);
		DECLARE cur5_ CURSOR FOR (SELECT RESOURCE_ID, ATTRIBUTE_NAME FROM METADATA_ELEMENT WHERE RESOURCE_ID IS NOT NULL);
		OPEN cur5_;
		
		FETCH NEXT FROM cur5_ INTO @theId, @theName;
		WHILE @@FETCH_STATUS = 0
		BEGIN
			IF (@theId IS NOT NULL AND @theName IS NOT NULL) 
			BEGIN
...
AS
		DECLARE @theId NVARCHAR(32);
		DECLARE @theName NVARCHAR(250);
		DECLARE cur6_ CURSOR FOR (SELECT RESOURCE_ID, NAME FROM METADATA_ELEMENT_PAGE_TEMPLATE WHERE RESOURCE_ID IS NOT NULL);
		OPEN cur6_;
		
		FETCH NEXT FROM cur6_ INTO @theId, @theName;
		WHILE @@FETCH_STATUS = 0
		BEGIN
			IF (@theId IS NOT NULL AND @theName IS NOT NULL) 
			BEGIN
...
AS
		DECLARE @theId NVARCHAR(32);
		DECLARE @theName NVARCHAR(250);
		DECLARE cur7_ CURSOR FOR (SELECT ADMIN_RESOURCE_ID, ROLE_NAME FROM ROLE WHERE ADMIN_RESOURCE_ID IS NOT NULL);
		OPEN cur7_;
		
		FETCH NEXT FROM cur7_ INTO @theId, @theName;
		WHILE @@FETCH_STATUS = 0
		BEGIN
			IF (@theId IS NOT NULL AND @theName IS NOT NULL) 
			BEGIN
...
AS
		DECLARE @theId NVARCHAR(32);
		DECLARE @theName NVARCHAR(250);
		DECLARE cur8_ CURSOR FOR (SELECT RESOURCE_ID, PATTERN FROM URI_PATTERN WHERE RESOURCE_ID IS NOT NULL);
		OPEN cur8_;
		
		FETCH NEXT FROM cur8_ INTO @theId, @theName;
		WHILE @@FETCH_STATUS = 0
		BEGIN
			IF (@theId IS NOT NULL AND @theName IS NOT NULL) 
			BEGIN
...
ALTER TABLE URI_PATTERN_META_VALUE ADD PROPAGETE_THROUGH_PROXY CHAR(1) NOT NULL DEFAULT 'Y';
