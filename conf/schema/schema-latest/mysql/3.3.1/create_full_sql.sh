...
bash add_to_file.sh "/data/openiam/conf/schema/mysql/3.2.3" $sqlFileName
bash add_to_file.sh "/data/openiam/conf/schema/mysql/3.2.4" $sqlFileName
bash add_to_file.sh "/data/openiam/conf/schema/mysql/3.2.5" $sqlFileName
bash add_to_file.sh "/data/openiam/conf/schema/mysql/3.2.6" $sqlFileName
bash add_to_file.sh "/data/openiam/conf/schema/mysql/3.2.7" $sqlFileName
bash add_to_file.sh "/data/openiam/conf/schema/mysql/3.3" $sqlFileName
bash add_to_file.sh "/data/openiam/conf/schema/mysql/3.3.1" $sqlFileName
