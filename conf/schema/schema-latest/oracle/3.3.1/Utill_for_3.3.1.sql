...
UPDATE MNG_SYS_OBJECT_MATCH set SEARCH_FILTER = '(&(objectclass=inetOrgPerson)(uid=?))' WHERE OBJECT_SEARCH_ID = '101' AND MANAGED_SYS_ID = '101' AND OBJECT_TYPE = 'USER' AND KEY_FIELD = 'uid' AND SEARCH_FILTER = '(&(objectclass=inetOrgPerson)(?))';
UPDATE MNG_SYS_OBJECT_MATCH set SEARCH_FILTER = '(&(objectclass=user)(CN=?))' WHERE OBJECT_SEARCH_ID = '110' AND MANAGED_SYS_ID = '110' AND OBJECT_TYPE = 'USER' AND KEY_FIELD = 'CN' AND SEARCH_FILTER = '(&(objectclass=user)(?))';
