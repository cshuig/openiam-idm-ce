...
BEGIN
  ...
  SELECT COUNT(CONSTRAINT_NAME) INTO itemExists FROM ALL_CONSTRAINTS
    WHERE UPPER(CONSTRAINT_NAME) = UPPER('CP_UI_THEME');
  ...
  colExists := 0;
  SELECT COUNT(CONSTRAINT_NAME) INTO itemExists FROM ALL_CONSTRAINTS
    WHERE UPPER(CONSTRAINT_NAME) = UPPER('URI_PATTERN_UI_THEME');
  IF itemExists > 0 THEN
...
BEGIN 
  SELECT count(*) INTO tCount FROM all_tables
    WHERE table_name = 'CP_AUTH_LEVEL_GRP_XREF';
  ...
  SELECT count(*) INTO tCount FROM all_tables
    WHERE table_name = 'URI_AUTH_LEVEL_GRP_XREF';
  ...
  END IF;
    ...
    SELECT count(*) INTO tCount FROM all_tables
    WHERE table_name = 'AUTH_LEVEL_ATTRIBUTE';
  ...
  SELECT count(*) INTO tCount FROM all_tables
    WHERE table_name = 'AUTH_LEVEL_GROUPING';
