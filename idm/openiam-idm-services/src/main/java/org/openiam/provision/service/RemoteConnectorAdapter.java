...
public class RemoteConnectorAdapter {
	...
	public UserResponse addRequest(ManagedSys managedSys,
			RemoteUserRequest addReqType, ProvisionConnector connector,
			...
			if (connector != null
				...
				if (msg != null) {
					...
					if (msg.getPayload() != null
							&& msg.getPayload() instanceof UserResponse) {
	...
	public UserResponse modifyRequest(ManagedSys managedSys,
			RemoteUserRequest request, ProvisionConnector connector,
			MuleContext muleContext) {
		UserResponse resp = new UserResponse();
		try {
			if (managedSys == null) {
	...
	public LookupResponse lookupRequest(ManagedSys managedSys,
			RemoteLookupRequest req, ProvisionConnector connector,
			MuleContext muleContext) {
		...
		try {
			...
			if (connector != null
				...
				if (msg != null) {
					log.debug("***Payload=" + msg.getPayload());
					if (msg.getPayload() != null
							&& msg.getPayload() instanceof LookupResponse) {
	...
	public UserResponse deleteRequest(ManagedSys managedSys,
			RemoteUserRequest request, ProvisionConnector connector,
			MuleContext muleContext) {
		UserResponse resp = new UserResponse();
	...
	public ResponseType setPasswordRequest(ManagedSys managedSys,
			RemotePasswordRequest request, ProvisionConnector connector,
			MuleContext muleContext) {
	...
	public ResponseType resetPasswordRequest(ManagedSys managedSys,
			RemotePasswordRequest request, ProvisionConnector connector,
			MuleContext muleContext) {
		ResponseType resp = new ResponseType();
	...
	public ResponseType suspend(ManagedSys managedSys, SuspendRequest request,
			ProvisionConnector connector, MuleContext muleContext) {
		ResponseType resp = new ResponseType();
	...
	public ResponseType resumeRequest(ManagedSys managedSys,
			ResumeRequest request, ProvisionConnector connector,
			MuleContext muleContext) {
		ResponseType resp = new ResponseType();
	...
	public ResponseType reconcileResource(RemoteReconciliationConfig config,
			ProvisionConnector connector, MuleContext muleContext) {
		ResponseType resp = new ResponseType();
		if (config == null) {
			resp.setStatus(StatusCodeType.FAILURE);
