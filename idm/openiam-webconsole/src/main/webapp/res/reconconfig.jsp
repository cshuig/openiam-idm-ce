...
<table width="800pt">
  ...
  <tr>
    <td class="msg" colspan="5" align="center"><b>Configuration has been successfully updated.</b></td>
  </tr>
  <%
  	}
  %>
              ...
              <fieldset class="userform">
                ...
                <table class="fieldsetTable" width="100%">
                  <tr>
                    ...
                    <td class="tdlightnormal"><form:select path="config.status">
                  ...
                  <tr>
                    ...
                    <td class="tdlightnormal"><form:select path="config.frequency" multiple="false">
                  ...
                  <c:forEach items="${reconCmd.situationList}" var="situationList" varStatus="sit">
                    <tr class="tdlight">
                      <td class="tableEntry">${situationList.situation} <form:hidden
                          path="situationList[${sit.index}].reconConfigId"
                        /> <form:hidden path="situationList[${sit.index}].reconSituationId" /> <form:hidden
                          path="situationList[${sit.index}].situation"
                        />
                      </td>
                      <td class="tableEntry"><form:select path="situationList[${sit.index}].situationResp">
                          <form:option value="" label="-Please Select-" />
                      ...
                      <td class="tableEntry"><form:input path="situationList[${sit.index}].script" size="30"
                          maxlength="60"
                        /></td>
                    </tr>
                  </c:forEach>
