                    ...
                    <tr>
                        ...
                        <td>
                            <form:select path="org.metadataTypeId">
                                ...
                                <form:options items="${orgDetailCmd.typeList}" itemValue="metadataTypeId"
                    ...
                    <tr>
                        ...
                        <td>
                            <form:select path="org.classification">
                                ...
                                <form:option value="DISTRICT" label="DISTRICT"/>
                                        ...
                                        <fieldset class="userform">
                                            ...
                                            <table class="resourceTable" cellspacing="2" cellpadding="2" width="600pt">
                                                ...
                                                <c:if test="${orgDetailCmd.orgAttributeSet != null}">
                                                    <c:forEach items="${orgDetailCmd.orgAttributeSet}"
                                                               var="orgAttributeSet" varStatus="attr">
                                                        <tr>
                                                            <td><form:input path="orgAttributeSet[${attr.index}].name"
                                                                            size="20"/>

                                                                <form:hidden
                                                                        path="orgAttributeSet[${attr.index}].attrId"/>
                                                                <form:hidden
                                                                        path="orgAttributeSet[${attr.index}].organizationId"/>
                                                            </td>
                                                            <td>
                                                                <form:input path="orgAttributeSet[${attr.index}].value"
                                                ...
                                                <tr>
                                                    <td colspan="2"><i>To remove a custom attribute, leave the name
                                                        blank</i><br>
                                                        <i>To add a new row, click on SAVE first. A new row will be
                                                            added.</i></td>
                                                </tr>
                                            </table>
                                    </td>
                        ...
                        <c:forEach items="${orgDetailCmd.childOrg}" var="org">
                            <tr>
                                ...
                                <td class="tableEntry"><a
                                        href="orgDetail.cnt?orgId=${org.orgId}">${org.organizationName}</a></td>
