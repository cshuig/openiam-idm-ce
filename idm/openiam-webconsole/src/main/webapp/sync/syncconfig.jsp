				...
				<td align="center" height="100%">
					<fieldset class="userform">
						...
						<table class="fieldsetTable" width="100%">
							...
							<tr class="common-row">
								...
								<td class="tdlightnormal"><form:select
									...
									</form:select> <form:errors path="syncConfig.synchAdapter" cssClass="error" />
							...
							<tr class="common-row">
								...
								<td class="normaltext"><form:input
									...
									<br> <i>Validates the row of data for accepting it
							...
							<tr class="common-row">
								...
								<td class="normaltext"><form:input
									...
									<br> <i>Transforms the data into a form that can be
							...
							<tr class="common-row">
								...
								<td class="tdlightnormal">
									<table>
										...
										<tr class="normaltext">
											<td>IDM Repository Field: <form:select
													path="syncConfig.matchFieldName" multiple="false">
													<form:option value="-" label="-Please Select-" />
											...
											<td>IDM CUSTOM ATTRIBUTE NAME:<form:input
													path="syncConfig.matchSrcFieldName" size="40"
													maxlength="40" />
											</td>
										</tr>
										<tr>
											...
											<td class="normaltext"><form:input
													path="syncConfig.customMatchAttr" size="40" maxlength="40" />
											</td>
										</tr>
							...
							<tr class="common-row">
								...
								<td class="normaltext"><form:input
									...
									<br> <i>Custom matching rules should only be used when
							...
							<tr>
								...
								<td class="tdlightnormal"><form:input
										path="syncConfig.queryTimeField" size="60" maxlength="60" />
								</td>
							</tr>
							<tr>
								<td class="tddark">Last Record Processed</td>
								<td class="tdlightnormal"><form:input
										path="syncConfig.lastExecTime" size="60" maxlength="60"
										readonly="true" /></td>
							</tr>
							<tr>
								<td class="tddark">Directory Last Record Processed</td>
								<td class="tdlightnormal"><form:input
										path="syncConfig.lastRecProcessed" size="60" maxlength="60"
										readonly="true" /></td>
						</TABLE>
						...
						<tr class="buttonRow">
							...
							<td align="right"><c:if
									test="${syncCmd.syncConfig.synchConfigId != null}">
									<input type="submit" name="btn" value="Delete"
										onclick="return confirm('Are you sure you want to delete this Configuration?');" />
									<input type="submit" name="btn" value="Sync Now"
										onclick="return confirm('Are your sure that you want to start synchronization?');" />
								</c:if> <input type="submit" name="btn" value="Test Connection" /> <input
								type="submit" name="btn" value="Submit" /> <input type="submit"
								name="btn" value="Reset" /></td>
						</tr>
				</TD>
			</TR>
		</table>
