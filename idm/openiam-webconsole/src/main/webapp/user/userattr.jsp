                ...
                <table width="900pt">
                                    ...
                                    <c:forEach items="${userAttrCmd.attributeList}" var="userAttr" varStatus="attr">
                                        ...
                                        <tr>
                                            <td class="tableEntry"><form:checkbox
                                                    path="attributeList[${attr.index}].selected"/></td>
                                            <td class="tableEntry">
                                                ...
                                                <c:if test="${userAttrCmd.attributeList[attr.index].id == null}">
                                                    <form:input path="attributeList[${attr.index}].name" size="20"
                                                                maxlength="50"/>
                                                </c:if>
                                                <c:if test="${userAttrCmd.attributeList[attr.index].id != null}">
                                            ...
                                            <td class="tableEntry"><form:input path="attributeList[${attr.index}].value"
                                            ...
                                            <c:if test="${elementAry != null}">
                                                <td class="tableEntry">
                                                    <form:select path="attributeList[${attr.index}].metadataElementId">
                                                        ...
                                                        <form:options items="${elementAry}"
                                                                      itemValue="metadataElementId"
                    ...
                    <tr>
                        <td class="buttonRow" align="right">
                            <input type="submit" name="saveBtn" value="Delete"/> <input type="submit" name="saveBtn"
                                                                                        value="Save"/> <input
                                type="submit" name="_cancel" value="Cancel"/>
                        </td>
                    </tr>
