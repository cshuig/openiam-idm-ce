        ...
        <table class="fieldsetTable" width="100%">
            ...
            <tr>
                ...
                <td class="userformInput" for="username" class="labelValue">
                    <form:input path="user.firstName" size="35" maxlength="40"
                                onchange="firstName.value = firstName.value.toProperCase();"/>
                ...
                <td class="userformInput" for="username" class="labelValue">
                    <form:input path="user.lastName" size="35" maxlength="40"
                                onchange="lastName.value = lastName.value.toProperCase();"/>
            ...
            <tr>
                ...
                <td colspan="3" class="userformInput" for="username" class="labelValue">
                    ...
                    <form:input path="supervisorName" size="35" readonly="true"/> <a
            ...
            <tr>
                ...
                <td colspan="3" class="userformInput" for="username" class="labelValue">
                    ...
                    <form:input path="alternateContactName" size="35" readonly="true"/> <a
                        href="javascript:showSupervisorDialog('user.alternateContactId', 'alternateContactName' );">Select
                    Alternate</a>
            ...
            <tr>
                ...
                <td class="userformInput" for="username" class="labelValue"><form:input path="user.birthdate"
                                                                                        size="20"/>(MM/dd/yyyy)<br>
            ...
            <tr>
                ...
                <td class="userformInput" for="username" class="labelValue"><form:input path="user.startDate"
                                                                                        size="20"/>(MM/dd/yyyy)<br>
                ...
                <td colspan="3" class="userformInput" for="username" class="labelValue"><form:input path="user.lastDate"
                                                                                                    size="20"/>(MM/dd/yyyy)<br>
            ...
            <tr>
                <td colspan="2"><label for="username" class="attribute">Last Password Change:</label></td>
                <td colspan="4" class="userformInput" for="username"
                    class="labelValue">${editUserCmd.user.datePasswordChanged}</td>

            </tr>
            <tr>
                <td colspan="2"><label for="username" class="attribute">Last Challenge Response Change:</label></td>
                <td class="userformInput" for="username" class="labelValue"
                    colspan="4">${editUserCmd.user.dateChallengeRespChanged}</td>
        ...
        <fieldset class="userformSearch">
            ...
            <table class="fieldsetTable" width="100%">
                ...
                <tr>
                    ...
                    <td colspan="5" class="userformInput" for="username" class="labelValue"><form:input path="email1"
                                                                                                        size="50"
                                                                                                        maxlength="320"/>
                ...
                <tr>
                    ...
                    <td colspan="5" class="userformInput" for="username" class="labelValue"><form:input path="email2"
                                                                                                        size="50"
                                                                                                        maxlength="320"/></td>
                </tr>
                <tr>
                        ...
                        <table class="resourceTable" cellspacing="2" cellpadding="2">
                            ...
                            <c:forEach items="${editUserCmd.phoneList}" var="phone" varStatus="ph">
                                ...
                                <tr>
                                    ...
                                    <td class="tableEntry"><form:input path="phoneList[${ph.index}].areaCd" size="5"
                                                                       maxlength="5"/></td>
                                    <td class="tableEntry"><form:input path="phoneList[${ph.index}].phoneNbr" size="15"
                                                                       maxlength="10"/></td>
                                    <td class="tableEntry"><form:input path="phoneList[${ph.index}].phoneExt" size="10"
                                                                       maxlength="5"/></td>
                                    <td class="tableEntry">
                ...
                <tr>
                    ...
                    <td class="userformInput" for="username" class="labelValue"><form:input path="user.bldgNum" size="5"
                                                                                            maxlength="5"/> <form:input
                            path="user.address1" size="20" maxlength="512"/></td>

                </tr>
                <tr>
                    <td></td>
                    <td class="userformInput" for="username" class="labelValue"><form:input path="user.address2"
                                                                                            size="30" maxlength="512" /></td>

                </tr>
                <tr>
                    <td><label for="username" class="attribute">City</label></td>
                    <td class="userformInput" for="username" class="labelValue"><form:input path="user.city"
                                                                                            size="30"/></td>
                ...
                <tr>
                    ...
                    <td class="userformInput" for="username" class="labelValue"><form:input path="user.state"
                                                                                            size="30"/></td>
                ...
                <tr>
                    ...
                    <td class="userformInput" for="username" class="labelValue"><form:input path="user.postalCd"
                                                                                            size="30"
                                                                                            maxlength="10"/></td>
