...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public AuthenticationResponse login( AuthenticationRequest request) {
        ...
        log.debug("Login request for :" + principal + " from: " + clientIP + " / " + nodeIP);
		...
		//	log.debug("loginModule=" + secDomain.getDefaultLoginModule());
            ...
            if (loginModName.equalsIgnoreCase("org.openiam.idm.srvc.auth.spi.DefaultLoginModule"))  {
                ...
                if (principal == null || principal.length()==0) {
                    ...
                    log("AUTHENTICATION", "AUTHENTICATION", "FAIL", "INVALID LOGIN", secDomainId, null, principal, null, null, clientIP, nodeIP);
                ...
                if (password == null 	|| password.equals("")) {
                    ...
                    log("AUTHENTICATION", "AUTHENTICATION", "FAIL", "INVALID PASSWORD", secDomainId, null, principal, null, null, clientIP, nodeIP);
		...
		//	log.debug("loginModule=" + secDomain.getDefaultLoginModule());
            ...
            if (loginModName.equalsIgnoreCase("org.openiam.idm.srvc.auth.spi.DefaultLoginModule"))  {
                ...
                if (principal == null || principal.length()==0) {
                    ...
                    log("AUTHENTICATION", "AUTHENTICATION", "FAIL", "INVALID LOGIN", secDomainId, null, principal, null, null, null, null);
                    //throw new AuthenticationException(AuthenticationConstants.RESULT_INVALID_LOGIN);
                ...
                if (password == null 	|| password.equals("")) {
                    ...
                    log("AUTHENTICATION", "AUTHENTICATION", "FAIL", "INVALID PASSWORD", secDomainId, null, principal, null, null, null, null);
                    //throw new AuthenticationException(AuthenticationConstants.RESULT_INVALID_PASSWORD);
