...
<html>
	<head>
		...
		<title>${titleOrganizatioName}-<fmt:message key="openiam.ui.saml.response.debug.tool" /></title>
	...
	<body>
      	<div id="title" class="title">
            <fmt:message key="openiam.ui.saml.response.debug.tool" />
      	</div>
			...
			<table cellpadding="8px" align="center" class="fieldset">
				<tbody>
					<tr>
						<td>
							<label>
								<fmt:message key="openiam.ui.saml.response" />
							</label>
						</td>
						<td>
							<textarea id="samlResponse" rows="40" cols="100"></textarea>
						</td>
					</tr>
				</tbody>
				<tfoot>
