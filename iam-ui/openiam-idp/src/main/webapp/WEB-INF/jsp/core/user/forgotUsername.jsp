				...
				<form id="forgot-principal-form" action="forgotUsername.html" method="post">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <input type="text" id="email" name="email" class="emailField" placeholder="${emailPlaceholder}" value="${requestScope.email}" initialized="${not empty requestScope.email}" />

                            <div>
                                <input id="submit" type="submit" class="redBtn loginBtn" value="<fmt:message key='openiam.idp.send.login.information' />" />
                            </div>
                        </c:otherwise>
                    </c:choose>
				</form>
