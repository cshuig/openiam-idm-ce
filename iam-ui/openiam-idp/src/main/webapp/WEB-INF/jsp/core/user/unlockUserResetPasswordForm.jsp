...
<html>
    ...
    <div id="pagebg">
			<div id="password">
				...
				<div id="credentials">
                    <fmt:message key="openiam.idp.enter.new.pswd.unlock.account" />
				</div>
				<form id="login-form" action="unlockUserResetPasswordForm.html" method="post">
					<input type="hidden" id="token" name="token" value="${requestScope.token}" autocomplete="off"/>
