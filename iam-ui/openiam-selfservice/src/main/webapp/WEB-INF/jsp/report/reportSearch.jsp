...
<html>
    <head>
		...
		<title>${titleOrganizatioName} - <fmt:message key="openiam.ui.common.reports"/></title>
		...
		<script type="text/javascript" src="/openiam-ui-static/js/selfservice/report/report.js"></script>
	...
	<body>
		<div id="title" class="title"><fmt:message key="openiam.ui.common.reports"/></div>
