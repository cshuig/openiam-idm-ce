...
<html>
    <head>
		...
		<title>${titleOrganizatioName} - <fmt:message key="openiam.ui.report.view.reports"/></title>
		...
		<script type="text/javascript" src="/openiam-ui-static/js/selfservice/view/viewReport.js"></script>
		<script type="text/javascript">
			OPENIAM = window.OPENIAM || {};
			OPENIAM.ENV = window.OPENIAM.ENV || {};
			OPENIAM.ENV.MenuTree = <c:choose><c:when test="${! empty requestScope.menuTree}">${requestScope.menuTree}</c:when><c:otherwise>null</c:otherwise></c:choose>;
			OPENIAM.ENV.ViewReportPageURL = "${requestScope.viewReportPageURL}";
		</script>
	</head>
	<body>
		<div id="title" class="title"><fmt:message key="openiam.ui.report.view.reports"/></div>
