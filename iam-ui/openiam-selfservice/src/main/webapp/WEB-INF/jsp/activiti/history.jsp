...
<html>
    <head>
		...
		<title>${titleOrganizatioName} - <fmt:message key="openiam.ui.selfservice.history.my.task.history" /></title>
		...
		<script type="text/javascript" src="/openiam-ui-static/js/selfservice/activiti/task.history.js"></script>
	...
	<body>
		<div id="title" class="title">
            <fmt:message key="openiam.ui.selfservice.history.my.task.history" />
		</div>
