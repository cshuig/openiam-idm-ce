...
<html>
    <head>
		...
		<title>${titleOrganizatioName}  - <fmt:message key="openiam.ui.selfservice.taskshistoryinstance.process.workflow" /></title>
		...
		<link href="/openiam-ui-static/js/common/membership/jOrgChart.css" rel="stylesheet" type="text/css" />
		...
		<script type="text/javascript" src="/openiam-ui-static/js/common/membership/jOrgChart.js"></script>
		<script type="text/javascript" src="/openiam-ui-static/js/selfservice/activiti/process.workflow.js"></script>
		...
		<script type="text/javascript">
			...
			OPENIAM.ENV.TaskId = "${requestScope.taskId}"
			OPENIAM.ENV.ExecutionId = "${requestScope.executionId}"
		</script>
	</head>
	<body>
		<div id="title" class="title">
            <fmt:message key="openiam.ui.selfservice.taskshistoryinstance.process.workflow" />: ${requestScope.task.name}.
            <c:if test="${! empty requestScope.task.createdTime}">
            	<fmt:message key="openiam.ui.selfservice.history.created.date" />:  <fmt:formatDate value="${requestScope.task.createdTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
            </c:if>
		</div>
		<div id="container" class="frameContentDivider">
			<div id="appendUL">
				<!-- 
