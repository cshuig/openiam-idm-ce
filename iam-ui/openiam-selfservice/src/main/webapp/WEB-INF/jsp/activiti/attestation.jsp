...
<html>
    <head>
		...
		<script type="text/javascript" src="/openiam-ui-static/js/selfservice/activiti/attestation.js"></script>
		...
		<script type="text/javascript">
			...
			OPENIAM.ENV.EmployeeId = "${requestScope.employee.id}";
			
			OPENIAM.ENV.Text = {
				MemberOfGroups : localeManager["openiam.ui.user.entitlement.group.title"],
				MemberOfRoles : localeManager["openiam.ui.user.entitlement.role.title"],
				EntitledOfResources : localeManager["openiam.ui.user.entitlement.resource.title"],
				NoResources : localeManager["openiam.ui.user.entitlement.resource.not.found"],
				NoGroups : localeManager["openiam.ui.user.entitlement.group.not.found"],
				NoRoles : localeManager["openiam.ui.user.entitlement.role.not.found"],
				ActionsText : localeManager["openiam.ui.selfservice.actions.text"]
			};
		</script>
	</head>
	<body>
		<div id="title" class="title">
            <fmt:message key="openiam.ui.selfservice.attestation.request.user" />: ${requestScope.employee.displayName}
		</div>
			...
			<ul class="formControls">
				<li>
					<a href="javascript:void(0)">
						<input id="accept" type="submit" class="redBtn" value="<fmt:message key="openiam.ui.selfservice.finalize.attestation.request" />" />
					</a>
				</li>
			</ul>
		</div>
