...
<html>
    <head>
		...
		<title>${titleOrganizatioName} - <fmt:message key="openiam.ui.selfservice.user.access.review.resource.dialog.title" /></title>
		...
		<script type="text/javascript" src="/openiam-ui-static/js/webconsole/user/user.search.js"></script>
	...
	<body>
		<div id="title" class="title">
            <fmt:message key="openiam.ui.selfservice.user.search.find.user.create.request" />
		</div>
