...
<head>
    ...
    <title>${titleOrganizatioName} - <fmt:message key="openiam.ui.user.entitlement.organization.title"/>
    </title>
    ...
    <script type="text/javascript" src="/openiam-ui-static/js/selfservice/user/user.organization.js"></script>
