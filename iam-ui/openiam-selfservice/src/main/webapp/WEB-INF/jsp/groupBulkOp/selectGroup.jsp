...
<c:set var="pageTitle">
  <fmt:message key="openiam.ui.shared.group.search" />
</c:set>
...
<head>
  ...
  <script type="text/javascript" src="/openiam-ui-static/js/common/group/group.search.js"></script>
  ...
  <script type="text/javascript">
    ...
    OPENIAM.ENV.OwnerId = ${requestScope.requesterId};
    OPENIAM.ENV.EntityUrl="javascript:void(0);";
    OPENIAM.ENV.emptyResultsText='<fmt:message key="openiam.ui.shared.group.search.empty"/>';
    OPENIAM.ENV.hasEditButton=false;
    OPENIAM.ENV.onEdit = null;
    OPENIAM.ENV.onAdd = function(bean){
        window.location.href = "selectUsers.html?id=" + bean.id;
    };
    OPENIAM.ENV.emptyResultsText=localeManager["openiam.ui.group.bulk.op.group.search.empty"];
  </script>
</head>
<body>
