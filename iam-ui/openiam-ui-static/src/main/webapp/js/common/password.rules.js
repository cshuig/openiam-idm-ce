        ...
        drawRules: function (rules) {
            ...
            if ($options.useTooltip) {
                if (isFirstShow) {
                    ...
                    $rulesSelector.tooltipster('content', $content);
                }
            } else {
    ...
    var methods = {
        init: function (args) {
            ...
            var $options = $.extend({
                ...
                tokenSelector: "#token",
                //loginSelector: '#managedSystemId',
                loginSelector: '#principal',
                loginValue: $('#principal').val(),
