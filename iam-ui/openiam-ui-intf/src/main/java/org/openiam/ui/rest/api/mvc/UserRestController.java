...
public class UserRestController extends AbstractController {
	...
	public @ResponseBody UserSearchFormBean populateSearchForm(final HttpServletRequest request, String requesterId) {
...
//        userSearchFormBean.addAdditionalSearchCriteria("organizationId");
    ...
    public @ResponseBody BeanResponse userAttributes(final HttpServletRequest request, 
	...
	public @ResponseBody BeanResponse searchUsers(final HttpServletRequest request, final @RequestBody UserSearchModel searchModel) {
		if(searchModel.isEmpty()) {
			return BeanResponse.EMPTY_RESPONSE;
		}

        BeanResponse beanResponse = new BeanResponse();
        UserSearchBean searchBean = searchModel.buildSearchBean(this.getRequesterId(request), UserSearchBean.class);
    ...
    public @ResponseBody List<String> searchUsersMetadata(final HttpServletRequest request) {
