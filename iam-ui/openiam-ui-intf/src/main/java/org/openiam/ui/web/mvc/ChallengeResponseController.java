...
@Controller
public class ChallengeResponseController extends AbstractController {
	...
	public String challengeResponse(final HttpServletRequest request,
		...
		final List<UserIdentityAnswer> answerList = challengeResponseService.findAnswerBeans(answerSearchBean, getRequesterId(request), 0, Integer.MAX_VALUE);
