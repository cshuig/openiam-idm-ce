...
public abstract class AbstractEntitlementsController<T extends KeyDTO> extends AbstractActivitiController {
    ...
    protected String getTaskName(final Resource entity, final boolean isDelete) {
        if (isDelete) {
            return this.getLocalizedMessage("task.name.delete.resource", new Object[]{entity.getName()});
        } else {
            if (StringUtils.isBlank(entity.getId())) {
                return this.getLocalizedMessage("task.name.create.resource", null);
            } else {
                return this.getLocalizedMessage("task.name.edit.resource", new Object[]{entity.getName()});
    ...
    protected String getTaskName(final Group entity, final boolean isDelete) {
        if (isDelete) {
            return this.getLocalizedMessage("task.name.delete.group", new Object[]{entity.getName()});

        } else {
            if (StringUtils.isBlank(entity.getId())) {
                return this.getLocalizedMessage("task.name.create.group", null);
            } else {
                return this.getLocalizedMessage("task.name.edit.group", new Object[]{entity.getName()});
            }
        }
    }
    ...
    protected String getTaskName(final Role entity, final boolean isDelete) {
        if (isDelete) {
            return this.getLocalizedMessage("task.name.delete.role", new Object[]{entity.getName()});
        } else {
            if (StringUtils.isBlank(entity.getId())) {
                return this.getLocalizedMessage("task.name.create.role", null);
            } else {
                return this.getLocalizedMessage("task.name.edit.role", new Object[]{entity.getName()});
            }
        }
    }
    ...
    protected String getTaskName(final Organization entity, final boolean isDelete) {
        if (isDelete) {
            return this.getLocalizedMessage("task.name.delete.organization", new Object[]{entity.getName()});
        } else {
            if (StringUtils.isBlank(entity.getId())) {
                return this.getLocalizedMessage("task.name.create.organization", null);
            } else {
                return this.getLocalizedMessage("task.name.edit.organization", new Object[]{entity.getName()});
            }
        }
    }
    ...
    private String getTaskName(final Resource entity, final User member, final boolean isAddition) {
        if (isAddition) {
            return this.getLocalizedMessage("task.name.entitle.resource.user", new Object[]{member.getDisplayName(), entity.getName()});
        } else {
            return this.getLocalizedMessage("task.name.disentitle.resource.user", new Object[]{member.getDisplayName(), entity.getName()});
        }
    }

    private String getTaskName(final Role entity, final User member, final boolean isAddition) {
        if (isAddition) {
            return this.getLocalizedMessage("task.name.make.role.user", new Object[]{member.getDisplayName(), entity.getName()});
        } else {
            return this.getLocalizedMessage("task.name.remove.role.user", new Object[]{member.getDisplayName(), entity.getName()});
        }
    }

    private String getTaskName(final Group entity, final User member, final boolean isAddition) {
        if (isAddition) {
            return this.getLocalizedMessage("task.name.make.group.user", new Object[]{member.getDisplayName(), entity.getName()});
        } else {
            return this.getLocalizedMessage("task.name.remove.group.user", new Object[]{member.getDisplayName(), entity.getName()});
        }
    }

    private String getTaskName(final User entity, final User member, final boolean isAddition) {
        if (isAddition) {
            return this.getLocalizedMessage("task.name.make.user.user", new Object[]{member.getDisplayName(), entity.getName()});
        } else {
            return this.getLocalizedMessage("task.name.remove.user.user", new Object[]{member.getDisplayName(), entity.getName()});
        }
    }

    private String getTaskName(final Organization entity, final User member, final boolean isAddition) {
        if (isAddition) {
            return this.getLocalizedMessage("task.name.make.organization.user", new Object[]{member.getDisplayName(), entity.getName()});
        } else {
            return this.getLocalizedMessage("task.name.remove.organization.user", new Object[]{member.getDisplayName(), entity.getName()});
        }
    }

    private String getTaskName(final Group entity, final Group member, final boolean isAddition) {
        if (isAddition) {
            return this.getLocalizedMessage("task.name.make.group.group", new Object[]{member.getName(), entity.getName()});
        } else {
            return this.getLocalizedMessage("task.name.remove.group.group", new Object[]{member.getName(), entity.getName()});
        }
    }

    private String getTaskName(final Group entity, final Role member, final boolean isAddition) {
        if (isAddition) {
            return this.getLocalizedMessage("task.name.make.group.role", new Object[]{member.getName(), entity.getName()});
        } else {
            return this.getLocalizedMessage("task.name.remove.group.role", new Object[]{member.getName(), entity.getName()});
        }
    }

    private String getTaskName(final Role entity, final Role member, final boolean isAddition) {
        if (isAddition) {
            return this.getLocalizedMessage("task.name.make.role.role", new Object[]{member.getName(), entity.getName()});
        } else {
            return this.getLocalizedMessage("task.name.remove.role.role", new Object[]{member.getName(), entity.getName()});
        }
    ...
    private String getTaskName(final Resource entity, final Resource member, final boolean isAddition) {
        if (isAddition) {
            return this.getLocalizedMessage("task.name.make.resource.resource", new Object[]{member.getName(), entity.getName()});
        } else {
            return this.getLocalizedMessage("task.name.remove.resource.resource", new Object[]{member.getName(), entity.getName()});
        }
    }

    protected String getTaskName(final Resource entity, final Role member, final boolean isAddition) {
        if (isAddition) {
            return this.getLocalizedMessage("task.name.entitle.resource.role", new Object[]{entity.getName(), member.getName()});
        } else {
            return this.getLocalizedMessage("task.name.disentitle.resource.role", new Object[]{entity.getName(), member.getName()});
        }
    }

    protected String getTaskName(final Resource entity, final Group member, final boolean isAddition) {
        if (isAddition) {
            return this.getLocalizedMessage("task.name.entitle.resource.group", new Object[]{entity.getName(), member.getName()});
        } else {
            return this.getLocalizedMessage("task.name.disentitle.resource.group", new Object[]{entity.getName(), member.getName()});
        }
    }
