...
<head>
    ...
    <title>${titleOrganizatioName} - <fmt:message key="openiam.ui.group.identities.page.title"/></title>
    ...
    <script type="text/javascript" src="/openiam-ui-static/js/webconsole/group/group.identities.js"></script>
...
<div id="title" class="title">
    <fmt:message key="openiam.ui.group.identities"/> : ${requestScope.group.name}
</div>
