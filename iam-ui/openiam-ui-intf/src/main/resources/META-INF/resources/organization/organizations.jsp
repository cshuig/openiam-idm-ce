...
<c:set var="pageTitle">
	<fmt:message key="openiam.ui.common.organizations" />
</c:set>
...
<html>
    <head>
		...
		<script type="text/javascript" src="/openiam-ui-static/js/common/organization/organization.search.js"></script>
		...
		<script type="text/javascript">
			...
			OPENIAM.ENV.OrganizationTypes = <c:choose><c:when test="${! empty requestScope.organizationTypes}">${requestScope.organizationTypes}</c:when><c:otherwise>null</c:otherwise></c:choose>;
		</script>
	</head>
	<body>
