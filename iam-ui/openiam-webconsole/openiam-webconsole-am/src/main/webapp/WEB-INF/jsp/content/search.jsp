...
<title>${titleOrganizatioName}-<fmt:message key="contentprovider.provider.search" /></title>
...
<script type="text/javascript" src="/openiam-ui-static/js/webconsole-am/contentprovider/search.js"></script>
...
<body>
      <div id="title" class="title">
            <fmt:message key="contentprovider.provider.search.title" />
      </div>
