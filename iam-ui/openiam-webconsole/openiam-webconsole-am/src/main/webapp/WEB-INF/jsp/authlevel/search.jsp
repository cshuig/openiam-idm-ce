...
<html>
    <head>
		...
		<title>${titleOrganizatioName} - <fmt:message key="openiam.ui.webconsole.am.authlevel.search.groupingsearch" /></title>
		...
		<script type="text/javascript" src="/openiam-ui-static/js/webconsole-am/authlevel/search.js"></script>
	...
	<body>
		<div id="title" class="title">
            <fmt:message key="openiam.ui.webconsole.am.authlevel.grouping.authentication" />
		</div>
