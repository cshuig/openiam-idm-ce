...
<html>
    <head>
		...
		<title>${titleOrganizatioName} - <spring:message key="openiam.ui.idm.prov.mngsys.title.managesSystem"/> </title>
		...
		<script type="text/javascript" src="/openiam-ui-static/js/webconsole-idm/mngsys/managedsys.search.js"></script>
		...
		<script type="text/javascript">
			...
			OPENIAM.ENV.Text = {
				EmptyText : localeManager["openiam.ui.idm.prov.mngsys.search.nogroupfound"]
			};
		</script>
	</head>
	<body>
		<div id="title" class="title">
            <fmt:message key="openiam.ui.idm.prov.mngsys.title.managesSystem"/>
		</div>
