...
<tr>
    <td><label> <spring:message
            code="openiam.ui.idm.prov.mngsys.field.attributeNamesLookup"
            />
    </label></td>
    <td><input id="attributeNamesLookup" name="attributeNamesLookup" type="text"
               maxlength="120" class="full rounded _input_tiptip"
               value="${requestScope.mngSystemCommand.attributeNamesLookup}"
               title="<spring:message code='openiam.ui.idm.prov.mngsys.title.attributeNamesLookup'/>"
            /></td>
</tr>
<tr>
    <td><label> <spring:message
