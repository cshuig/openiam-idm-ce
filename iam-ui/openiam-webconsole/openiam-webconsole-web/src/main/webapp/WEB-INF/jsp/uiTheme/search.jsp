...
<title>${titleOrganizatioName}-<fmt:message key="webconsole.ui.theme.head" />
</title>
...
<script type="text/javascript" src="/openiam-ui-static/js/webconsole/uithemes/ui.theme.search.js"></script>
...
<body>
      <div id="title" class="title">
            <fmt:message key="webconsole.ui.theme.title" />
      </div>
