...
<html>
	<head>
		...
		<title><fmt:message key="metadata.type.search.title" /></title>
		...
		<script type="text/javascript" src="/openiam-ui-static/js/webconsole/metadata/metadata.type.search.js"></script>
		<script type="text/javascript">
			OPENIAM = window.OPENIAM || {};
			OPENIAM.ENV = window.OPENIAM.ENV || {};
			OPENIAM.ENV.ContextPath = "${pageContext.request.contextPath}";
			OPENIAM.ENV.MenuTree = <c:choose><c:when test="${! empty requestScope.menuTree}">${requestScope.menuTree}</c:when><c:otherwise>null</c:otherwise></c:choose>;
			OPENIAM.ENV.Groupings = <c:choose><c:when test="${! empty requestScope.groupingsAsJSON}">${requestScope.groupingsAsJSON}</c:when><c:otherwise>null</c:otherwise></c:choose>;
		</script>
	</head>
	<body>
	      <div id="title" class="title">
	            <fmt:message key="metadata.type.search.title" />
	      </div>
