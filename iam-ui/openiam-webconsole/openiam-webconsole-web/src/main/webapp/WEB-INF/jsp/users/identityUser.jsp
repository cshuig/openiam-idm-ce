...
<html>
	<head>
	    ...
	    <title>${titleOrganizatioName} - <fmt:message key="openiam.ui.user.identities.page.title"/></title>
	    ...
	    <script type="text/javascript" src="/openiam-ui-static/js/webconsole/user/user.identities.js"></script>
	...
	<body>
		<div id="title" class="title">
            <fmt:message key="openiam.ui.user.identities"/> : ${requestScope.user.displayName}
		</div>
