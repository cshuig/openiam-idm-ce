...
<title><fmt:message key="metadata.search.title" /></title>
...
<script type="text/javascript" src="/openiam-ui-static/js/webconsole/metadata/metadata.search.js"></script>
...
<body>
      <div id="title" class="title">
            <fmt:message key="metadata.search.title" />
      </div>
