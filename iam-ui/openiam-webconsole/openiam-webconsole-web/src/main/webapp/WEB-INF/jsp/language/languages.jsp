...
<title><fmt:message key="openiam.ui.common.metadatatype.search" /></title>
...
<script type="text/javascript" src="/openiam-ui-static/js/webconsole/language/language.search.js"></script>
<script type="text/javascript">
			...
			OPENIAM.ENV.Text = {
				EmptyResults : localeManager["openiam.ui.webconsole.languages.not.founded"]
			}
		</script>
</head>
<body>
      <div id="title" class="title">
            <spring:message code="openiam.ui.webconsole.languages.title" />
      </div>
