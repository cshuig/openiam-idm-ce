...
<c:set var="pageTitle">
    <fmt:message key="openiam.ui.common.reconciliation.header" />
</c:set>
...
<head>
    ...
    <script type="text/javascript" src="/openiam-ui-static/js/common/mngsys/recon.search.js"></script>
    ...
    <script type="text/javascript">
        ...
        OPENIAM.ENV.ReconciliationTypes = <c:choose><c:when test="${! empty requestScope.reconciliationTypes}">${requestScope.reconciliationTypes}</c:when><c:otherwise>null</c:otherwise></c:choose>;
...
<div id="title" class="title">
    <input id="managedSysId" type="hidden" value="${requestScope.mngSystem.id}" />
    <fmt:message key="openiam.ui.common.reconciliation.title" />: ${requestScope.command.mSysName}
</div>
