...
<html>
	<head>
	    ...
	    <title>${titleOrganizatioName} - <fmt:message key="openiam.ui.custom.fields.search.title" /></title>
	    ...
	    <script type="text/javascript" src="/openiam-ui-static/js/webconsole/customFields/field.search.js"></script>
	    ...
	    <script type="text/javascript">
	        ...
	        OPENIAM.ENV.FieldTypes = <c:choose><c:when test="${! empty requestScope.typeListAsJSON}">${requestScope.typeListAsJSON}</c:when><c:otherwise>null</c:otherwise></c:choose>;
	    </script>
	</head>
	<body>
		<div id="title" class="title">
            <fmt:message key="openiam.ui.custom.fields.custom.fields" />
		</div>
