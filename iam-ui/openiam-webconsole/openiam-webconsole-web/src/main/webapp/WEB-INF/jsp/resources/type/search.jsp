...
<title>${titleOrganizatioName}-<fmt:message key="openiam.webconsole.resource.type.search" /></title>
...
<script type="text/javascript" src="/openiam-ui-static/js/common/resource/resource.type.search.js"></script>
...
<script type="text/javascript">
			...
			OPENIAM.ENV.Text = {
					EmptyText :  localeManager["openiam.webconsole.resource.type.search"]
			};
		</script>
</head>
<body>
      <div id="title" class="title"><fmt:message key="openiam.webconsole.resource.types" /></div>
