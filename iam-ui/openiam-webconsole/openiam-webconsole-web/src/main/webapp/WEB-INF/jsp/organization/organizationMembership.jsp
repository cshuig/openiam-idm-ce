...
<html>
    <head>
		...
		<script type="text/javascript">
			...
			<c:choose>
				<c:when test="${requestScope.type eq 'childorganizations'}">
					OPENIAM.ENV.Text.EmptyChildren = localeManager["openiam.ui.selfservice.organization.empty.children"];
					OPENIAM.ENV.Text.SearchDialogTitle = localeManager["openiam.ui.selfservice.organization.search.dialog.title"];
					OPENIAM.ENV.Text.EmptySearch = localeManager["openiam.ui.selfservice.organization.empty.search"];
				...
				<c:when test="${requestScope.type eq 'parentorganizations'}">
					OPENIAM.ENV.Text.EmptyChildren = localeManager["openiam.ui.selfservice.organization.empty.parent"];
	...
	<body>
		<div id="title" class="title">
			...
			<div id="usermenu">
				<li>
					<a <c:if test="${requestScope.type eq 'childorganizations'}">class="active"</c:if> href="organizationMembership.html?id=${requestScope.organization.id}&type=childorganizations"><fmt:message key="openiam.ui.common.child.organizations" /></a>
				</li>
				<li>
					<a <c:if test="${requestScope.type eq 'parentorganizations'}">class="active"</c:if> href="organizationMembership.html?id=${requestScope.organization.id}&type=parentorganizations"><fmt:message key="openiam.ui.common.parent.organizations" /></a>
				</li>
			</div>
		</div>
