...
<div class="frameContentDivider">
    <form id="resetPasswordForm">
        <table cellpadding="8px" align="center" class="fieldset">
            ...
            <tr>
                <td>
                    <label id="managedSystemIdLabel" for="managedSystemId"><fmt:message
                            key="openiam.ui.user.password.managedSys"/>:</label>
                    <select id="managedSystemId" name="managedSystemId" class="rounded">
                        <c:forEach items="${userManagedSystems}" var="mngSys">
                            <option value="${mngSys.key}">${mngSys.value}</option>
                        </c:forEach>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <ul class="formControls">
                        ...
                        <li class="leftBtn">
                            <a href="javascript:void(0)">
                                <input id="resyncPasswordBtn" class="redBtn" style="width: 50px;"
