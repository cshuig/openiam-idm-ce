...
<html>
	<head>
	    ...
	    <title>${titleOrganizatioName} - <fmt:message key="openiam.ui.common.organization.location.title"/></title>
	    ...
	    <script type="text/javascript" src="/openiam-ui-static/js/webconsole/organization/location.search.js"></script>
	...
	<body>
		<div id="title" class="title">
            <fmt:message key="openiam.ui.common.organization.location.title"/> : ${requestScope.organization.name}
		</div>
