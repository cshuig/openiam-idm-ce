...
<html>
    <head>
		...
		<title>${titleOrganizatioName} - <fmt:message key="openiam.webconsole.organization.type.search" /></title>
		...
		<script type="text/javascript" src="/openiam-ui-static/js/webconsole/organization/organization.type.search.js"></script>
		<script type="text/javascript">
			...
			OPENIAM.ENV.Text = {
				EmptyResults : localeManager["openiam.webconsole.organization.type.no.found"]
			}
		</script>
	</head>
	<body>
		<div id="title" class="title"><fmt:message key="openiam.webconsole.organization.type.search" /></div>
