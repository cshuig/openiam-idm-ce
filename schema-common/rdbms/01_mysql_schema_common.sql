...
CREATE TABLE GRP_ORG(
	   COMPANY_ID           varchar(32) NOT NULL,
       GRP_ID               varchar(32) NOT NULL,
	PRIMARY KEY (COMPANY_ID, GRP_ID),
       CONSTRAINT FK_ORG_GRP_ORG
       FOREIGN KEY (COMPANY_ID)  REFERENCES COMPANY(COMPANY_ID),
       CONSTRAINT FK_GRP_GRP_ORG
       FOREIGN KEY (GRP_ID)  REFERENCES GRP(GRP_ID)
) ENGINE=InnoDB;
...
CREATE TABLE LOGIN(
	   ...
	   LOGIN_ATTR_IN_TARGET_SYS     VARCHAR(40) NULL,   /* Indicates which attribute in the target system holds the login    */
