...
CREATE TABLE IAMUSER.USERS(
	   ...
	   ADDRESS3             VARCHAR2(255) NULL,
	   ADDRESS4             VARCHAR2(255) NULL,
	   ADDRESS5             VARCHAR2(255) NULL,
	   ADDRESS6             VARCHAR2(255) NULL,
	   ADDRESS7             VARCHAR2(255) NULL,
...
CREATE TABLE IAMUSER.LOCATION (
	   ...
	   BLDG_NUM				VARCHAR2(10) NULL,
	   STREET_DIRECTION		VARCHAR2(20) NULL,
       ADDRESS1             VARCHAR2(512) NULL,
       ADDRESS2             VARCHAR2(512) NULL,
...
CREATE TABLE IAMUSER.IDM_AUDIT_LOG (
      ...
      CUSTOM_PARAMNAME1       	VARCHAR2(255) NULL,
...
CREATE TABLE IAMUSER.REPORT_CRITERIA_PARAMETER (
    ...
    CONSTRAINT FK_RCP_REPORT_INFO
       ...
       REFERENCES IAMUSER.REPORT_INFO(REPORT_INFO_ID),
    CONSTRAINT FK_RCP_REPORT_PARAMETER_TYPE
       FOREIGN KEY (RCPT_ID)
       REFERENCES IAMUSER.REPORT_PARAMETER_TYPE(RCPT_ID),
