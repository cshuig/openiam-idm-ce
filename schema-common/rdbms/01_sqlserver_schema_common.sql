...
CREATE TABLE COMPANY (
	   ...
	   INTERNAL_COMPANY_NAME  NVARCHAR(200) NULL,
...
CREATE TABLE USERS(
	   ...
	   DATE_PASSWORD_CHANGED		datetime2 NULL,
	   DATE_CHALLENGE_RESP_CHANGED	datetime2 NULL,
       PRIMARY KEY (USER_ID), 
...
CREATE TABLE USER_ATTACHMENT_REF (
       USER_ATTACH_REF_ID   nvarchar(32) NOT NULL,
       USER_ID              nvarchar(32) NULL,
       NAME                 nvarchar(20) NULL,
...
CREATE TABLE LOGIN(
       ...
       /* Cannot be utf8 because of length, see http://bugs.mysql.com/bug.php?id=4541 */
       ...
       PWD_CHANGED          datetime2 NULL,				/* last time the password was changed */
       PWD_EXP              datetime2 NULL,				/* date when the pswd expires */
       ...
       GRACE_PERIOD			datetime2 NULL, 				/* WHEN THE GRACE_PRD_EXP 	*/	
       CREATE_DATE			datetime2 NULL,
       CREATED_BY			nvarchar(32) NULL,
       ...
       LAST_AUTH_ATTEMPT	datetime2 NULL,	    	/* WHEN WAS THE LAST AUTH. ATTEMPT  */   
	   LAST_LOGIN			datetime2 NULL,			/* LAST TIME THE PERSON SUCCESSFULLY LOGGED IN */
	   LAST_LOGIN_IP        nvarchar(60) NULL,
	   PREV_LOGIN           datetime2 NULL,
	   ...
	   LOGIN_ATTR_IN_TARGET_SYS     nvarchar(40) NULL,   /* Indicates which attribute in the target system holds the login    */
       PSWD_RESET_TOKEN_EXP datetime2 NULL,
...
CREATE TABLE AUTH_STATE (
       AUTH_STATE_ID        nvarchar(32) NOT NULL,
       USER_ID              nvarchar(32) NOT NULL,
...
CREATE TABLE IDM_AUDIT_LOG (
      ...
      ACTION_DATETIME 	datetime NULL,               /* DATE AND TIME THIS EVENT OCCURED.                                          */
      ACTION_END_DATETIME 	datetime NULL,               /* DATE AND TIME THIS EVENT OCCURED.                                          */
...
/*ALTER TABLE PHONE - cannot use alter table to create index in oracle or sqlserver*/ 
  CREATE INDEX "PHONE_AREA_CD_PHONE_NBR" ON PHONE(AREA_CD, PHONE_NBR);
...
CREATE  TABLE RESOURCE_PRIVILEGE (
  ...
  PRIVILEGE_TYPE  nvarchar(20)   NULL, /* VALUE LIKE ROLE, GROUP, MODULE NAME */
  DESCRIPTION     nvarchar(40)   NULL,
...
CREATE TABLE NOTIFICATION_CONFIG (
       ...
       SEARCH_COMPANY_ID        nvarchar(32) NULL,
       SEARCH_LAST_NAME         nvarchar(50) NULL,
       SEARCH_DEPT_ID           nvarchar(32) NULL,
       SEARCH_DIVISION          nvarchar(32) NULL,
       SEARCH_USER_STATUS       nvarchar(20) NULL,
       TEMPLATE_URL             nvarchar(80) NULL,
       MSG_TEXT                 ntext NULL,
...
CREATE TABLE REPORT_INFO(
	...
	REPORT_NAME nvarchar(64) NOT NULL UNIQUE,
    DATASOURCE_FILE_PATH nvarchar(255) NOT NULL,
    REPORT_FILE_PATH nvarchar(255),
...
CREATE TABLE REPORT_PARAMETER_TYPE (
    RCPT_ID nvarchar(32) NOT NULL,
    TYPE_NAME nvarchar(64) NOT NULL UNIQUE,
...
CREATE TABLE REPORT_CRITERIA_PARAMETER (
    ...
    CONSTRAINT UK_REPORT_INFO_ID_PARAM_NAME UNIQUE (REPORT_INFO_ID, PARAM_NAME)
)
...
CREATE TABLE REPORT_SUBSCRIPTIONS (
  ...
  DELIVERY_METHOD nvarchar(45),
  DELIVERY_FORMAT nvarchar(45),
  DELIVERY_AUDIENCE nvarchar(45),
  STATUS            nvarchar(45),
  USERID            nvarchar(45),
...
CREATE TABLE REPORT_SUB_CRITERIA_PARAM (
  ...
  PARAM_VALUE     nvarchar(64),
    PRIMARY KEY (RCP_ID),
    CONSTRAINT FK_REPORT_SUB_CRITERIA_PARAM_REPORT_SUB
       FOREIGN KEY (REPORT_SUB_ID)
       REFERENCES REPORT_SUBSCRIPTIONS(REPORT_SUB_ID)
)
