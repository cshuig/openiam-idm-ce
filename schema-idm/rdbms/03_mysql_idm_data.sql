...
insert into MENU (menu_id, menu_group, menu_name,menu_desc,url,LANGUAGE_CD, DISPLAY_ORDER) values('DELG_FILTER','QUERYUSER','Delegation Filter','Delegation Filter','userDelegationFilter.cnt', 'en',9);
...
insert into POLICY (POLICY_ID, POLICY_DEF_ID, NAME, DESCRIPTION, STATUS, CREATE_DATE, CREATED_BY, RULE_TEXT,  RULE_SRC_URL) VALUES ('4657','104', 'manager', 'manager', 1,curdate(), '3000', '','provision/manager.groovy');
insert into POLICY (POLICY_ID, POLICY_DEF_ID, NAME, DESCRIPTION, STATUS, CREATE_DATE, CREATED_BY, RULE_TEXT,  RULE_SRC_URL) VALUES ('4658','104', 'ad-manager', 'ad-manager', 1,curdate(), '3000', '','provision/ad/manager.groovy');
...
INSERT INTO MANAGED_SYS (MANAGED_SYS_ID, NAME, DESCRIPTION, STATUS, CONNECTOR_ID, DOMAIN_ID, HOST_URL, PORT, COMM_PROTOCOL, RESOURCE_ID, HNDLR_5) VALUES('101','LDAP', 'Primary Directory', 'ACTIVE', '51', 'USR_SEC_DOMAIN', 'ldap://','389', 'CLEAR', '101', 'LDAP'   );
...
INSERT INTO MANAGED_SYS (MANAGED_SYS_ID, NAME, DESCRIPTION, STATUS, CONNECTOR_ID, DOMAIN_ID, HOST_URL, PORT, COMM_PROTOCOL, RESOURCE_ID, HNDLR_5) VALUES('110','ACTIVE DIRECTORY', 'ACTIVE DIRECTORY', 'ACTIVE', '51', 'USR_SEC_DOMAIN', 'ldaps://','636', 'CLEAR', '110', 'ACTIVE_DIRECTORY'   );
...
insert into MNG_SYS_OBJECT_MATCH(OBJECT_SEARCH_ID, MANAGED_SYS_ID, OBJECT_TYPE, MATCH_METHOD, SEARCH_FILTER, BASE_DN, SEARCH_BASE_DN ,KEY_FIELD) VALUES('110', '110', 'USER', 'BASE_DN', '(&(objectclass=user)(?))','OU=idm-test,DC=ad,DC=openiamdemo,DC=info','OU=idm-test,DC=ad,DC=openiamdemo,DC=info','CN');
...
INSERT INTO ATTRIBUTE_MAP(ATTRIBUTE_MAP_ID, MANAGED_SYS_ID, RESOURCE_ID, MAP_FOR_OBJECT_TYPE, ATTRIBUTE_NAME, ATTRIBUTE_POLICY_ID, STATUS, DATA_TYPE ) VALUES ('529', '110', '110','USER', 'manager', '4658', 'IN-ACTIVE', 'String');
...
/* MAP FOR ORACLE DB */
INSERT INTO ATTRIBUTE_MAP(ATTRIBUTE_MAP_ID, MANAGED_SYS_ID, RESOURCE_ID, MAP_FOR_OBJECT_TYPE, ATTRIBUTE_NAME, ATTRIBUTE_POLICY_ID) VALUES ('560', '111', '111','PRINCIPAL', 'MyAttributeAttrName', '4562');
INSERT INTO ATTRIBUTE_MAP(ATTRIBUTE_MAP_ID, MANAGED_SYS_ID, RESOURCE_ID, MAP_FOR_OBJECT_TYPE, ATTRIBUTE_NAME, ATTRIBUTE_POLICY_ID) VALUES ('561', '111', '111','PASSWORD', 'MyPasswordAttrName', '4603');

UPDATE ATTRIBUTE_MAP
SET DATA_TYPE = 'string'
where DATA_TYPE IS NULL AND MANAGED_SYS_ID = '111';
...
insert into RECONCILIATION_SITUATION(RECON_SITUATION_ID, RECON_CONFIG_ID, SITUATION, SITUATION_RESP, SCRIPT) VALUES('1101', '110', 'IDM[exists] and Resource[not exists]', 'CREATE_RES_ACCOUNT', '/recon/LDAPPopulationScript.groovy');
insert into RECONCILIATION_SITUATION(RECON_SITUATION_ID, RECON_CONFIG_ID, SITUATION, SITUATION_RESP, SCRIPT) VALUES('1102', '110', 'IDM[exists] and Resource[exists]', 'NOTHING', '');
insert into RECONCILIATION_SITUATION(RECON_SITUATION_ID, RECON_CONFIG_ID, SITUATION, SITUATION_RESP, SCRIPT) VALUES('1103', '110', 'IDM[not exists] and Resource[exists]', 'CREATE_IDM_ACCOUNT', '/recon/LDAPPopulationScript.groovy');
insert into RECONCILIATION_SITUATION(RECON_SITUATION_ID, RECON_CONFIG_ID, SITUATION, SITUATION_RESP, SCRIPT) VALUES('1104', '110', 'IDM[deleted] and Resource[exists]', 'NOTHING', '');
...
INSERT INTO NOTIFICATION(MSG_ID,MSG_NAME,PROVIDER_SCRIPT,MSG_TYPE) VALUES('402888ea3d9ad61c013d9adce1b2000b','ACCOUNT_INACTIVE','AccountInactiveNotification.groovy','SYSTEM');
