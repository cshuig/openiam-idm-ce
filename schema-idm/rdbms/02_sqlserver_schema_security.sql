...
CREATE TABLE POLICY (
       ...
       ENABLEMENT           INT NULL DEFAULT 1,
	   RULE_TEXT			ntext NULL
...
CREATE TABLE RESOURCE_POLICY (
       ...
       POLICY_START         datetime2 NULL,
       POLICY_END           datetime2 NULL,
...
CREATE TABLE PROV_REQUEST(
    ...
    REQUESTOR_ID          nvarchar(32),    /* CAN BE NULL IN SELF-REGISTRATION */
    REQUESTOR_FIRSTNAME   nvarchar(50),   /* AVOIDS A LOOKUP ON USERS*/
    REQUESTOR_LASTNAME    nvarchar(50),    /* AVOIDS A LOOKUP ON USERS*/
    REQUEST_DATE        datetime2,
    STATUS              nvarchar(20),
    STATUS_DATE         datetime2,
    REQUEST_REASON      nvarchar(1000),
	REQUEST_TYPE        nvarchar(50),
	WORKFLOW_NAME       nvarchar(50),
	CHANGE_ACCESS_BY	nvarchar(32),
	REQUEST_XML 		ntext,
	REQUEST_TITLE       nvarchar(200) NULL,
...
CREATE TABLE REQUEST_USER(
    ...
    LOCATION_CD         nvarchar(32),
    AFFILIATION         nvarchar(32),
    REQUEST_ID          nvarchar(32)   NULL,
...
CREATE TABLE RECONCILIATION_CONFIG (
  ...
  CSV_LINE_SEPARATOR          nVARCHAR(10) NULL DEFAULT 'comma',
  CSV_END_OF_LINE             nVARCHAR(10) NULL DEFAULT 'enter',
  NOTIFICATION_EMAIL_ADDRESS  nVARCHAR(80) NULL,
...
CREATE TABLE MAIL_TEMPLATE(
	TMPL_ID nvarchar(32) NOT NULL,
	TMPL_NAME nvarchar(64) NOT NULL UNIQUE,
    TMPL_SUBJECT nvarchar(64) NOT NULL,
    BODY_TYPE nvarchar(16) NOT NULL,
    ATTACHMENT_FILE_PATH nvarchar(64),
    BODY ntext,
    PRIMARY KEY (TMPL_ID)
)

CREATE TABLE NOTIFICATION(
	MSG_ID nvarchar(32) NOT NULL,
	MSG_NAME nvarchar(64) NOT NULL UNIQUE,
    PROVIDER_SCRIPT nvarchar(64),
    TMPL_ID nvarchar(32),
    START_DATE  DATE NULL,
    END_DATE  DATE NULL,
    MSG_TYPE nvarchar(32),
    PRIMARY KEY (MSG_ID),
...
(    (
    ...
    DATEDIFF(day,  GRACE_PERIOD, GETDATE())= 1
    )
   OR
   (
    PWD_EXP IS NOT NULL AND GRACE_PERIOD IS NULL AND
    DATEDIFF(day, PWD_EXP, GETDATE()) = 1
    )
);
