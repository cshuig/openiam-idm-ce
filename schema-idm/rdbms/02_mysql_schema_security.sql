...
CREATE TABLE MANAGED_SYS (
	   ...
	   SEARCH_HNDLR							VARCHAR(100) NULL,
	   LOOKUP_HNDLR							VARCHAR(100) NULL,
 	   TEST_CONNECTION_HNDLR				VARCHAR(100) NULL,
 	   RECONCILE_RESOURCE_HNDLR				VARCHAR(100) NULL,
...
CREATE TABLE PROV_REQUEST(
    ...
    REQUESTOR_ID          VARCHAR(32),    /* CAN BE NULL IN SELF-REGISTRATION */
    REQUESTOR_FIRSTNAME   VARCHAR(50),   /* AVOIDS A LOOKUP ON USERS*/
    REQUESTOR_LASTNAME    VARCHAR(50),    /* AVOIDS A LOOKUP ON USERS*/
...
CREATE TABLE RECONCILIATION_CONFIG (
  ...
  CSV_LINE_SEPARATOR          VARCHAR(10) NULL DEFAULT 'comma',
  CSV_END_OF_LINE             VARCHAR(10) NULL DEFAULT 'enter',
  NOTIFICATION_EMAIL_ADDRESS  VARCHAR(80) NULL,
  TARGET_SYS_MATCH_SCRIPT     VARCHAR(120) NULL,
